...
from staffing_base.models import StaffNotification, Job, Event, UserJob
...
def send_signup_email(job_data_list,user,template_path,bp,**kwargs):
    ...
    param: job_data_list is the result of the query in staffing_base.signup.get_job_rows (a list of recs)
...
def process_commitment_reminder():
    ...
    from staffing_base.views.signup import mod as signup_blueprint, get_job_rows
