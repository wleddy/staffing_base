...
from staffing_base.models import Event, ActivityGroup, Job, JobRole
from staffing_base.views.activity import get_event_recs
from staffing_base.views.signup import get_volunteer_role_ids
