...
from staffing_base.models import Activity, Event, ActivityType
from staffing_base.views.event import edit as edit_event, edit_from_activity as edit_event_from_activity
